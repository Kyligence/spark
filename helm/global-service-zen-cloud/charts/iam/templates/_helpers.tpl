...
*/}}
{{- define "iam.toolOptions" -}}
{{- $group := .Values.global.nacos.discovery.group -}}
{{- $publicGroup := .Values.global.nacos.discovery.group -}}
{{- $discoveryServerAddr := default (print "nacos-naming-svc." .Release.Namespace ":8848") .Values.nacos.discovery.serverAddr }}
{{- $configServerAddr := default (print "nacos-config-svc." .Release.Namespace ":8848") .Values.nacos.config.serverAddr }}
