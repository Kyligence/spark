...
{{- $tag := coalesce .global.logTag .service.tag .loki.tag .defaultVersion | toString -}}
...
{{- $tag := coalesce .global.logTag .service.tag | toString -}}
{{- printf "%s/%s:%s" $registry .service.repository $tag -}}
{{- end -}}
