 ...
 */
def call(String project, String branch, Boolean fromRemote=false, String repo='Kyligence', String refspec = '+refs/heads/*:refs/remotes/origin/*', String certificate=null, Boolean syncGitMirror=true) {
