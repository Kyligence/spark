...
select
   arrayMap(x -> floor(x, 4), original_medians_array.medians_by_version[2] as l) l_rounded,
   arrayMap(x -> floor(x, 4), original_medians_array.medians_by_version[3] as r) r_rounded,
